...
SELECT FROM Person.Contact ORDER BY FirstName, LastName DESC
...
FROM Person.Contact
WHERE ContactID IN (1,2,3,4,5,6)
UNION ALL
SELECT ContactID, FirstName
FROM Person.Contact
WHERE ContactID IN (1,3,5,7)

-
SELECT Person.Person.*, Ε.*
FROM Person.Person P INNER JOIN Human Resources. Employee E ON 
